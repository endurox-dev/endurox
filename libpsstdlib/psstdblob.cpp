...
static PSInteger _blob_releasehook(PSUserPointer p, PSInteger size)
{
...
static PSRegFunction _blob_methods[] = {
...
static PSRegFunction bloblib_funcs[]={
