...
- XATMI process calls joins the transaction by call of xa_start(). Previous versions
...
There are several databases which provide incomplete support for XOpen Groups
XA Standard implementation. 
