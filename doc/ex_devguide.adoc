...
*Bold applies to (in asciidoc asterisks)*:
...
'Underline applies to (in asciidoc single quotes)':

- Configuration tables (e.g. '<NDRX_QPREFIX>,shm,p2s').

- Configuration parameters (e.g. '-j', '-k').
