...
When Bnext steps onto *BFLD_VIEW* type field, Bnext initializes the 'buf' as assuming
it is *BVIEWFLD* with trailing data. Thus the BVIEWFLD.data is set to memory address of 
