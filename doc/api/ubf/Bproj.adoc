...
DESCRIPTION
-----------
This function removes any un-needed field from buffer 'p_ub' and keeps only the list of field identifiers found in 'fldlist' array. The array must be terminated with *BADFLDID*.
