...
TODO: tmqueue/tmsrv flags and group flags
...
<endurox>
    ...
    ...
        ...
        <server name="tmsrv">
            ...
            <srvid>60</srvid>
            <cctag>RM1TMQ</cctag>
            <sysopt>-e ${NDRX_ULOG}/tmsrv-rm1.log -r -- -t1 -l/kvmpool/data/test/tmlogs/rm1 -n2 -X2 -r30 -h180</sysopt>
        ...
        <server name="tpbridge">
            ...
            <appopt>-f -n<other_node_id> -r -i <binding_or_host_ip> -p <binding_or_host_port> -t<A_for_client_B_for_server> -z5 -c2</appopt>
        </server>
        ...
        <server name="tmrecoversv">
            <min>1</min>
