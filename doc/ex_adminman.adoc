...
configuration on each node, which runs periodically. That will allow housekeeping
any orphaned prepared transactions, which in case of a missing *STONITH* device, might
be generated by a faulty Enduro/X cluster node.
...
underlaying hardware and software infrastructure shall provide certain capabilities.
