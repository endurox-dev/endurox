...
image:netxms_service_chk.png[caption="Figure 5: ", title="Business Service for status indicator"]
...
==== Average response time over several servers for one service;
...
image:netxms_avg_rsp.png[caption="Figure 6: ", title="Average response time"]


==== Number of successful processed messages for one service with several servers;
...
image:netxms_succ.png[caption="Figure 7: ", title="Successful requests processed by service copies"]


==== Cumulative number of messages waiting in queues (for all services);
...
image:netxms_qsize.png[caption="Figure 8: ", title="Number of messages in queue"]


==== TPS for one service with several servers;
...
image:netxms_tps.png[caption="Figure 9: ", title="TPS Configuration"]

image:netxms_tps_transf.png[caption="Figure 10: ", title="TPS transformation"]
