...
developer needs to figure out how, it can be convert the code to avoid such API
...
Enduro/X ships with the configuration migration tool *ubbex(8)*. Tool accepts valid
...
Typically, Enduro/X application are configured with third environment file
...
. In case if providing patches by your self, prior submitting the changes to Github
https://github.com/endurox-dev/endurox project, do not forget to Sign and send us
