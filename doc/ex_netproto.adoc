...
|0x125D|nodeid_isnull|INT1|Mand|0|If set to *1*, indicates that nodeid is 
...
|0x127B|cltname|STRING0..60|Client binary naem used for broadcast matching.
|0x1285|cltname_isnull|INT1|If set to *1* indicates that recipients shall
be matched by process name. If set to *0* *cltname* matching is not used.
|0x1299|reply_to|STRING0..128|
...
|0x12E9|timestamp|LONG1..20|
|0x12F3|callseq|USHORT1..5|
|0x12FD|msgseq|USHORT1..5|
|0x1307|timer|NTIMER|
|0x131B|data|MUBF|
|0x1325|destnodeid|LONG1..20|
|=========================================================
