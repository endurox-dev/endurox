...
basic data types. This document uses term "block", "typed block" and "structures" 
...
|USHOR | 16bit unsigned value.
|=========================================================

== Multi-buffer block (array of)
...
.List of basic data types
|=========================================================
|TLV TAG |Format |Condition |Description
|
|
