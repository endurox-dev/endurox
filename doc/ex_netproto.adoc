...
|0x11B5|user4|LONG1..20|Mand|0|Any|For smart cache events indicates the
*tpurcode* to be cached.
...
|0x11BD|extradata|STRING0..41|Empty|Any|Extra call data. Currently Enduro/X uses
this for:
- Event delivery (?)
|=========================================================
