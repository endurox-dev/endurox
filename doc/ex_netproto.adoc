...
|LONG | Signed long field. 32bit or 64bit value. Depending on platfrom.
...
|ULONG | Unsigned long. 32 or 64 bit value. . Depending on platfrom.
In case if range is specified and upper value is greater than *10*, then
for 32bit platforms this is defaulted to *10*.
...
|=========================================================
|TLV TAG | Name | Format | Cond | Default value | Description
|0x1159,  "stdhdr",    OFSZ0,                            EXF_NONE,    XINC, 1, PMSGMAX, M_stdhdr_x},
