...
<endurox>
    ...
    <defaults>
        ...
        <envs group="SV_ENV_GROUP_NAME">
            <env name="SV_ENV_VARIABLE_NAME">SV_ENV_VARIABLE_VALUE</env>
            <env name="SV_ENV_VARIABLE_NAME_UNSET" unset="y" />
            ...
            <env name="SV_ENV_VARIABLE_NAME_N">SV_ENV_VARIABLE_VALUE_N</env>
        </envs>
        ...
        <envs group="SV_ENV_GROUP_NAME_N">
            ...
        </envs>
    </defaults>
    <servers>
        <server name="SERVER_BINARY_NAME">
            ...
            <envs>
                <usegroup>SV_ENV_GROUP_NAME</usegroup>
                ...
                <usegroup>SV_ENV_GROUP_NAME_N</usegroup>
    ...
    <clients>
        <envs group="CLT_ENV_GROUP_NAME">
            <env name="CLT_ENV_VARIABLE_NAME">CLT_ENV_VARIABLE_VALUE</env>
            <env name="CLT_ENV_VARIABLE_NAME_UNSET" unset="y" />
            ...
            <env name="CLT_ENV_VARIABLE_NAME_N">CLT_ENV_VARIABLE_VALUE_N</env>
        </envs>
        ...
        <envs group="CLT_ENV_GROUP_NAME_N">
            ...
        </envs>
        <client cmdline="CLT_COMMAND_LINE [${NDRX_CLTTAG} ${NDRX_CLTSUBSECT}]" 
            ...
            <envs>
                <usegroup>CLT_ENV_GROUP_NAME</usegroup>
                ...
                <usegroup>CLT_ENV_GROUP_NAME_N</usegroup>
