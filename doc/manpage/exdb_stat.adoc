...
NAME
----
exdb_stat - LMDB/NDRXDB environment status tool


SYNOPSIS
--------
*exdb_stat* [*-V*] [*-e*] [*-f*[*f*[*f*]]] [*-n*] [*-r*[*r*]] [*-a* | *-s* 'subdb']  *envpath*


DESCRIPTION
-----------

The *exdb_stat* utility displays the status of an NDRXDB environment.
...
[*-n*]::
Display the status of an NDRXDB database which does not use subdirectories.
