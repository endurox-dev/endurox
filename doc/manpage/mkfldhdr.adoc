...
-----------------------------------------------------
$/**
$ * Service test ud file.
$ *
$ * @file       test.fd
$ * @copyright  Mavimax, SIA
$ * @version    SVN: $Id$
$ */
...
T_PTR_FLD		21	ptr		- Pointer to XATMI buffer
T_UBF_FLD		22	ubf		- Embedded buffer
T_VIEW_FLD		23	view	- View field

$#endif
-----------------------------------------------------

Example output after utility run (test.fd.h):
...
#define	T_PTR_FLD	((BFLDID32)301990909)	/* number: 1021	 type: ptr */
#define	T_UBF_FLD	((BFLDID32)335545342)	/* number: 1022	 type: ubf */
#define	T_VIEW_FLD	((BFLDID32)369099775)	/* number: 1023	 type: view */
#endif
-----------------------------------------------------
