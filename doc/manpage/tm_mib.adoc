...
- Field *TA_EX_UVTYP* (short): Entry type codes: *1* - string based data and value
is loaded into *TA_EX_UVSTR*. *2* - data type is int32, and value is loaded into
*TA_EX_UVINT32*. *3* - data type is Gauge32 and value is loaded into *TA_EX_UVG32*.
*4* - data type is Counter64 and value is loaded into *TA_EX_UVC64*. When
