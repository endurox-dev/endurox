...
Enterprise Edition provides the SNMP MIB file at */usr/share/endurox/snmp/mibs/ENDUROX-MIB.txt*.
...
- *T_CLIENT* data table (SNMP *enduroxClientTable*): *1.3.6.1.4.1.55065.10.2.2.1*.

- *T_DOMAIN* data table (SNMP *enduroxDomainTable*): *1.3.6.1.4.1.55065.10.2.2.2*.

- *T_MACHINE* data table (SNMP *enduroxMachineTable*): *1.3.6.1.4.1.55065.10.2.2.3*.

- *T_QUEUE* data table (SNMP *enduroxQueueTable*): *1.3.6.1.4.1.55065.10.2.2.4*.

- *T_SERVER* data table (SNMP *enduroxServerTable*): *1.3.6.1.4.1.55065.10.2.2.5*.

- *T_SERVICE* data table (SNMP *enduroxServiceTable*): *1.3.6.1.4.1.55065.10.2.2.6*.

- *T_SVCGRP* data table (SNMP *enduroxSvcgrpTable*): *1.3.6.1.4.1.55065.10.2.2.7*.

- *T_BRCON* data table (SNMP *enduroxBrconTable*): *1.3.6.1.4.1.55065.10.2.2.8*.

- *T_USERDATA* data table (SNMP *enduroxUserdataTable*): *1.3.6.1.4.1.55065.10.2.2.100*.
