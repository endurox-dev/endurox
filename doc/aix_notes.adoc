...
performance reasons, it is recommended to mount a memory based partition where middleware can store
these files.
...
You may expirience issues with libxml2 version between freeware and AIX system provided.
