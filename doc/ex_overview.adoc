...
. System can run with out the main Enduro/X daemon (ndrxd). It is much like running the Tuxedo with 
    ...
    instance with out service interruption;
...
| expluginbase.h | Enduro/X plugin APIs
