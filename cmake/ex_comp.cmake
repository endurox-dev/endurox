...
macro(ex_comp_settings)
    ...
    OPTION(DEFINE_SYSVQEM "Force System V Queue, emulated" OFF)
    ...
    if ( ${CMAKE_CXX_COMPILER_ID} STREQUAL "GNU" OR ${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang" OR ${CMAKE_CXX_COMPILER_ID} STREQUAL "AppleClang" )
        ...
        if (DEFINE_RELEASEBUILD)
            ...
            IF (DEFINE_SANITIZE)
                SET(CMAKE_CXX_FLAGS "-fsanitize=address -fno-omit-frame-pointer -fno-inline-functions -O1 -ggdb ${CMAKE_CXX_FLAGS}")
            else()
    ...
    if ( ${CMAKE_C_COMPILER_ID} STREQUAL "GNU" OR ${CMAKE_C_COMPILER_ID} STREQUAL "Clang" OR ${CMAKE_C_COMPILER_ID} STREQUAL "AppleClang")
        ...
        if (DEFINE_RELEASEBUILD)
            ...
            IF (DEFINE_SANITIZE)
                SET(CMAKE_C_FLAGS "-fsanitize=address -fno-omit-frame-pointer -fno-inline-functions -O1 -ggdb ${CMAKE_C_FLAGS}")
            else()
    ...
    if( CMAKE_OS_NAME STREQUAL "LINUX" )
        ...
        IF(DEFINE_SYSVQEM)
            message("Linux - forced System V poll, emulated q")
            set(EX_USE_SYSVQ "1")
            set(EX_USE_SYSVQEM "1")
        ELSEIF(DEFINE_SYSVQ)
            message("Linux - forced System V poll")
            set(EX_USE_SYSVQ "1")
