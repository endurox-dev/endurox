 ...
 */
public int JSON_prepare_incoming (typed_buffer_descr_t *descr, char *rcv_data, 
 ...
 * @return
 */
public char * JSON_tpalloc (typed_buffer_descr_t *descr, long len)
{
    char *ret;
 ...
 * @return
 */
public char * JSON_tprealloc(typed_buffer_descr_t *descr, char *cur_ptr, long len)
{
    char *ret=NULL;
    char fn[] = "JSON_tprealloc";
 ...
 * @param buf
 */
public void JSON_tpfree(typed_buffer_descr_t *descr, char *buf)
{
    NDRX_FREE(buf);
}
 ...
 */
public int JSON_test(typed_buffer_descr_t *descr, char *buf, BFLDLEN len, char *expr)
{
    int ret=FALSE;
