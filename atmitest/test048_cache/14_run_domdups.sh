...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY2"}' \
    -m '{"T_STRING_FLD":"KEY2"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY3"}' \
    -m '{"T_STRING_FLD":"KEY3"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY4"}' \
    -m '{"T_STRING_FLD":"KEY4"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY5"}' \
    -m '{"T_STRING_FLD":"KEY5"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY6"}' \
    -m '{"T_STRING_FLD":"KEY6"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY7"}' \
    -m '{"T_STRING_FLD":"KEY7"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY8"}' \
    -m '{"T_STRING_FLD":"KEY8"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY9"}' \
    -m '{"T_STRING_FLD":"KEY9"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY10"}' \
...
(time ./testtool48 -sTESTSV14 -b '{"T_STRING_FLD":"KEY11"}' \
...
ensure_field db13 SV14KEY11 T_STRING_FLD KEY11 1
ensure_field db13 SV14KEY10 T_STRING_FLD KEY10 1
ensure_field db13 SV14KEY9 T_STRING_FLD KEY9 1
ensure_field db13 SV14KEY8 T_STRING_FLD KEY8 1
ensure_field db13 SV14KEY7 T_STRING_FLD KEY7 1
ensure_field db13 SV14KEY6 T_STRING_FLD KEY6 1
ensure_field db13 SV14KEY5 T_STRING_FLD KEY5 1
ensure_field db13 SV14KEY4 T_STRING_FLD KEY4 1
ensure_field db13 SV14KEY3 T_STRING_FLD KEY3 1
ensure_field db13 SV14KEY2 T_STRING_FLD KEY2 1
ensure_field db13 SV14KEY1 T_STRING_FLD KEY1 1
...
xadmin ci -d db13 -k SV14KEY6

ensure_field db13 SV14KEY7 T_STRING_FLD KEY7 1
ensure_field db13 SV14KEY6 T_STRING_FLD KEY6 0
ensure_field db13 SV14KEY5 T_STRING_FLD KEY5 1
...
xadmin ci -d db13 -k SV14KEY1. -r

ensure_field db13 SV14KEY11 T_STRING_FLD KEY11 0
ensure_field db13 SV14KEY10 T_STRING_FLD KEY10 0
ensure_field db13 SV14KEY9 T_STRING_FLD KEY9 1
