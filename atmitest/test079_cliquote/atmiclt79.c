...
int main(int argc, char** argv)
{
    ...
    NDRX_ASSERT_VAL_OUT((0==strcmp(argv[1], "ANOTHER HELLO WORLD")), "Invalid first token");
    NDRX_ASSERT_VAL_OUT((0==strcmp(argv[2], "'")), "Invalid second token");
    NDRX_ASSERT_TP_OUT(EXSUCCEED==tpinit(NULL), "Failed to init!");
