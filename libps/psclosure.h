...
{
private:
	PSClosure(PSSharedState *ss,PSFunctionProto *func){_function = func; __ObjAddRef(_function); _base = NULL; INIT_CHAIN();ADD_TO_CHAIN(&_ss(this)->_gc_chain,this); _env = NULL;}
public:
	static PSClosure *Create(PSSharedState *ss,PSFunctionProto *func){
	...
	{
		PSFunctionProto *f = _function;
		PSClosure * ret = PSClosure::Create(_opt_ss(this),f);
		ret->_env = _env;
