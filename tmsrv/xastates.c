...
/* If abort is logged, report error as TPEABORT */
{XA_TX_STAGE_ABORTING,         XA_OP_COMMIT,    TPEABORT},
{XA_TX_STAGE_ABORTED_HAZARD,   XA_OP_COMMIT,    TPEABORT},
{XA_TX_STAGE_ABORTED_HEURIS,   XA_OP_COMMIT,    TPEABORT},
