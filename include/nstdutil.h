...
extern NDRX_API void ndrx_str_unescape(char *input, const char *symbs);
extern NDRX_API char *ndrx_strtokblk ( char *input, const char *delimit, const char *qotesymbs);
