 ...
 * -----------------------------------------------------------------------------
 */
#ifndef __TYPED_CARRAY_H
#define	__TYPED_CARRAY_H
...
extern int CARRAY_prepare_outgoing (typed_buffer_descr_t *descr, char *idata, long ilen, 
...
extern char * CARRAY_tpalloc (typed_buffer_descr_t *descr, const char *subtype, long *len);
