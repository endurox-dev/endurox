...
#define	EX_CC_FORMAT_FIELD	((BFLDID32)167772665)	/* number: 505	 type: string */
#define	EX_CC_FORMAT_FORMAT	((BFLDID32)167772666)	/* number: 506	 type: string */
#define	EX_CC_RESULT_CODE	((BFLDID32)507)	/* number: 507	 type: short */
#define	EX_CC_RESULT_MSG	((BFLDID32)167772668)	/* number: 508	 type: string */
