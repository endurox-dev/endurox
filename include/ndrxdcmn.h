/* 
** Common/shared data structures between server & client.
**
** @file ndrxdcmn.h
** 
** -----------------------------------------------------------------------------
...
typedef struct
{
    ...
    n_timer_t   qopen_time;         /* Timer when q was open */
...
extern int cmd_generic_call_2(int ndrxd_cmd, int msg_src, int msg_type,
                            command_call_t *call, size_t call_size,
                            char *reply_q,
                            mqd_t reply_queue, /* listen for answer on this! */
                            mqd_t admin_queue, /* this might be FAIL! */
