...
#define NDRX_BANNER(X)                            \
    ...
    {\
        ...
        fprintf(stderr, "Copyright (C) 2009-2016 ATR Baltic SIA.\n");\
        fprintf(stderr, "Copyright (C) 2017-2024 Mavimax SIA. All Rights Reserved.\n\n");\
...
extern NDRX_API void ndrx_tplogprintubf(int lev, const char *title, UBFH *p_ub);
